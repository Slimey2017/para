...
function setupBody(step) {
  ...
  const bodies = [
    ...
    `<div class="setup-question"><span class="eyebrow">Other Accounts</span><h1>Connect another service?</h1><p class="lede">You can skip this and continue setting up PARA.</p><div class="setup-provider-list">${accountProviderRows(OTHER_PROVIDERS, "otherAccounts", choices.otherAccounts, choices.accountMode)}</div><p class="setup-legal-copy">Google / YouTube uses read-only account access. <a href="/privacy" target="_blank" rel="noopener noreferrer">Read the Privacy Policy</a>.</p></div>`,
    `<div class="setup-question"><span class="eyebrow">Privacy</span><h1>Choose what PARA can use</h1><p class="lede">These optional services remain off unless you choose to enable them.</p><div class="setup-fixed-list">${privacyRow("diagnostics", "Diagnostics", "Share reliability and performance information", Boolean(choices.privacy?.diagnostics))}${privacyRow("personalization", "Personalization", "Use activity to tailor suggestions", Boolean(choices.privacy?.personalization))}${privacyRow("location", "Location services", "Allow apps to request your location", Boolean(choices.privacy?.location))}</div><p class="setup-legal-copy"><a href="/privacy" target="_blank" rel="noopener noreferrer">Read the PARA Privacy Policy</a></p></div>`,
